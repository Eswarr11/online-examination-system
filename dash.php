...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="image.jpg" width=100 height=100 alt="Eswar" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Instagram">Eswar</a>
      ...
      <p>
        <div class="row">
          ...
          <div class="col-md-12" style="font-family: 'typo';">
            ...
            This research effort the individuals under consideration were students who would be enrolling in computer courses or Technologies Registrations. 
            A prototype of a web-based placement examination system is described from the standpoint of the research effort, end user, and software development.
          </div>
        </div>
      </p>
    </div>
